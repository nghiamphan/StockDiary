...
public class StockSingleton {
    ...
    private HashMap<String, HashMap<Long, Float>> mHistoryChartPrices = new HashMap<>();
    ...
    public HashMap<String, HashMap<Long, Float>> getHistoryChartPrices() {
        return mHistoryChartPrices;
    }
}
